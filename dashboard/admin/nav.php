...
<img src="download.jpg"  height="150"  width="300">
	...
	<li class="" ><a href="view_mem.php" ><i class="entypo-users"></i><span>Members</span></a>  </li>

	<!-- <li class="" id="hassubopen"><a href="view_mem.php" ><i class="entypo-users"></i><span>Members</span></a> -->
		<!-- <ul id="memExpand">
			<li class="active">
				<a href="view_mem.php"><span>Edit Members</span></a></li>

			<li><a href="table_view.php"><span>ALL Details of Memeber</span></a></li>
		</ul> -->
	<!-- </li> -->

	<li id="health_status"><a href="new_health_status.php"><i class="entypo-user-add"></i><span>Health Status</span></a> 	

		<li class="" ><a href="view_plan.php" ><i class="entypo-quote"></i><span>Plan</span></a>
	...
	<li class="" ><a href="reactivate.php" ><i class="entypo-users"></i><span>Reactivate Members</span></a>  </li>


	<li id="adminprofile"><a href="attendance.php"><i class="entypo-folder"></i><span>Attendance</span></a></li>
