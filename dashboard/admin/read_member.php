...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
   ...
   <body class="page-body  page-fade" onload="collapseSidebar()">
		...
		<h3>Member History</h3>
			...
			Details : <?php 
			$id     = $_POST['name'];
			$query  = "select * from users u  INNER JOIN enrolls_to e  on u.userid=e.uid  WHERE userid='$id'";
			//echo $query;
						...
						if (mysqli_affected_rows($con) != 0) {
						    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
						      ...
						      if($result2){
						        ...
						        echo '<td><a href="gen_invoice.php?id='.$row['uid'].'&pid='.$row['pid'].'&etid='.$row['et_id'].'"><input type="button" class="a1-btn a1-blue" value="Payment slip" ></a></td></tr>';
						        $memid = 0;
						    }
