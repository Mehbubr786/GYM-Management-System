         ...
         <tr>
           <td height="35"><table width="100%" border="0" align="center">
            ...
            <tr>
               ...
               <td height="35"><input type="text" id="boxx" name="calorie" pattern="[0-9]*" value='<?php echo $cal?>'></td>
             </tr>
            <tr>
               <td height="35">HEIGHT:</td>
               <td height="35"><input type="text" id="boxx" name="height" pattern="[0-9]*" value='<?php echo $hei?>'placeholder="Enter Height in cm"></td>
             </tr>
             ...
             <tr>
               ...
               <td height="35"><input type="text" id="boxx" name="weight" pattern="[0-9]*" value='<?php echo $wei?>'placeholder="Enter Weight in kg"></td>
             </tr>
            <tr>
               <td height="35">FAT:</td>
               <td height="35"><input type="text" id="boxx" name="fat" pattern="[0-9]*" value='<?php echo $fa?>'></td>
             </tr>
			 <tr>
