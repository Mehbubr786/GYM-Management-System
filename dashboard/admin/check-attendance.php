...
<?php
 ...
 //else {<!-- Visit codeastro.com for more projects -->
   ...
   $sql = "INSERT INTO attendance (userid, curr_date,curr_time,present)
  ...
  $row_attend = mysqli_fetch_array($result_attend);
   $cnt = $row_attend['attendance_count'];
    $attend_count = $attend_count + 1;
     $sql1 = "UPDATE users SET attendance_count = attendance_count + '$attend_count' where userid='$user_id'";
     $con->query($sql1) ;
