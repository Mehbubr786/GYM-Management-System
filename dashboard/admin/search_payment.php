...
<head>
    ...
    <style>
      ...
      <body class="page-body  page-fade" onload="collapseSidebar()">
		...
		<h2> Searched member for payment</h2>
		...
		<table class="table table-bordered datatable" id="table-1" border=1>
			<thead class="thead-dark">
				...
				<?php
					...
					$query  = "select * from enrolls_to where renewal='yes' and uid in(select userid from users where status = 1 and username like '%". $_POST['search'] ."%') ORDER BY expire";
					//echo $query;
					    ...
					    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
					        ...
					        if (mysqli_affected_rows($con) == 1) {
					            while ($row1 = mysqli_fetch_array($result1, MYSQLI_ASSOC)) {
					                ...
					                <input type='hidden' name='exp' value='" . $row['expire'] . "'/>
							...
							{
								echo "<tr><th>No  Members Found</th></tr>";
							}
