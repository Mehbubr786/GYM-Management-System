       ...
       <form id="form1" name="form1" method="post" class="a1-container" action="new_submit.php">
         ...
         <tr>
           <td height="35"><table width="100%" border="0" align="center">
               ...
               <td height="35"><input  type ="text" name="u_name" pattern="[a-zA-Z][a-zA-Z ]{2,}" id="boxx"  required/></td>
             </tr>
             <tr>
               <td height="35">STREET NAME:</td>
               <td height="35"><input  name="street_name" id="boxx"  pattern="[a-zA-Z][a-zA-Z ]{2,}"  required/></td>
             </tr>
             <tr>
               <td height="35">CITY:</td>
               <td height="35"><input <input type="text" name="city" id="boxx" pattern="[a-zA-Z][a-zA-Z ]{2,}" required/ ></td>
             </tr>
            ...
            <tr>
			 ...
			 <tr>
               ...
               <td height="35"><input type="text" pattern="[0-9]*"  minlength="10" name="mobile" id="boxx" maxlength="10" autocomplete="off" required="" ></td>
             </tr>
			  <tr>
