...
<table id =space width="760" height="397" border="0" align="center">
  <tr>
    <td width="222" height="198"><img src="download.jpg" width="200" height="150"  alt=""/></td>
    <td width="317"><p><strong> THE GYM IRON PARADISE</strong></p>
      <p>Mehbub</p>
      <p>khan</p></td>
    <td height="198"><p>Serial No : <?php echo $row['et_id'] ?></p>
      <p>&nbsp;</p>
      <p>Joining Date : <?php echo $row['join_date']?></p>
       <p>Expire Date : <?php echo $row['expire']?></p>
